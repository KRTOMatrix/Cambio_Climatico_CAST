...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h2>Cambio climático reciente<br>Provincia de A Coruña';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
function popup12(feature, layer) {
	...
	if (feature.properties && feature.properties.Prec_rel) {
		layer.bindTooltip("<strong>Cambio en la precipitación: </strong>"+  
...
*/
	{
	label: '<strong>Mapas de cambio climático reciente por municipios',
	children: [
	
	    { label: "Cambio en la temperatura",layer: mapa11},
	    { label: "Cambio en la precipitación",layer: mapa12},
...
var overlayTree = {
	...
	children: [
		...
		{ label: "Hidrografía y comunicaciones", layer: positron},
...
*/
	var htmlLegend11 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Cambio en la temperatura media anual entre los periodos 1999-2018 y 1971-1990'+"<\h3>",
			layer: geojson11,
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				label:"<h4>"+  'Método: Modelización estadística e interpolación espacial.<br> Promedio espacial por municipios'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
	...
	var htmlLegend12 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Cambio relativo de la precipitación anual promedio entre los periodos 1999-2018 y 1971-1990'+"<\h3>",
			layer: geojson12,
		image:'<img src="images/LOGO_GEN.png"',
	...
	map.addControl(htmlLegend12);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Tipos de cambio climático.<br> Del periodo 1971-1990 al periodo 1999-2018'+"<\h3>",
			layer: geojson13,
		image:'<img src="images/LOGO_GEN.png"',
